...
int advanced_binary(int *array, size_t size, int value)
{
	if (!array)
		return (-1);
	return (most_advanced_binary(array, value, 0, size - 1));
}
/**
...
/**
 * most_advanced_binary - a helper to do binary search recursively
 * @array: the array
...
int most_advanced_binary(int *array, int value, size_t low, size_t high)
{
	...
	if (array[mid] == value)
	{
		if (array[mid - 1] == value)
			return (most_advanced_binary(array, value, low, mid));
		else
			return (mid);
	}
	if (array[mid] < value)
		return (most_advanced_binary(array, value, mid + 1, high));
	if (array[mid] > value)
		return (most_advanced_binary(array, value, low, mid));
	return (-1);
}